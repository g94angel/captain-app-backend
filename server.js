...
app.post(
  'https://claimform-api.onrender.com/upload',
  upload,
  async (req, res) => {
...
app.post(
  'https://claimform-api.onrender.com/uploads',
  multipleUploads,
  async (req, res) => {
    let urls = '';
...
app.get(
  'https://claimform-api.onrender.com/getclaims',
...
app.post(
  'https://claimform-api.onrender.com/newclaim',
  controller.newClaim,
  (req, res) => {
...
app.put(
  'https://claimform-api.onrender.com/updateclaim',
...
app.delete(
  'https://claimform-api.onrender.com/deleteclaim/:id',
